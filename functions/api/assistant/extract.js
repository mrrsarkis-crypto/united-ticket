...
const EXTRACT_SYSTEM = [
  ...
  'Read drivingLicenseNumber only from the labeled Driver License Number box. Never copy a violation code/section, officer number, radar/lidar number, or other numeric field into it.',
  'Read officerId only from the SERIAL NO. field associated with the arresting/citing officer. Never use the Radar/Lidar number as officerId.',
  'Read location only from the labeled Location of Violation field.',
